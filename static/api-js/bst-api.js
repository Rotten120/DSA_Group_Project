...
async function deleteGraph(graph_name) {
...
async function renameGraph(old_name, new_name) {
...
//------------ NODE OPERATIONS ---------------//
async function createNode(graph_name, value) {
...
async function updateNode(graph_name, old_value, new_value) {
...
async function deleteNode(graph_name, value) {
